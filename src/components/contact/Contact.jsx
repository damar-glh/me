...
const Contact = ({isDarkMode}) => {
  ...
  const sendEmail = (e) => {
    e.preventDefault();
    emailjs.sendForm('service_wvf4pq8', 'template_2v81nv8', form.current, '_Dt1BYMz8cfuTqKDD')
    e.target.reset();
  };
  return (
    <section className={`contact section ${isDarkMode ? "dark-mode" : "light-mode"}`} id="contact" data-aos="fade-up" data-aos-anchor-placement="center-center" data-aos-easing="linear" data-aos-duration="1000">
            ...
            <div className="contact__content">
                ...
                <form ref={form} onSubmit={sendEmail} action="" className="contact__form">
                  <div className="contact__form-div">
                    <label htmlFor="" className="contact__form-tag">Nama</label>
